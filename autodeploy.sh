...
# any downtime.
# Example of use:
# $ ./autodeploy.sh jaguar/simpleapi 07 k8syamls/deployment.yaml
...
# Successfully tagged jaguar/simpleapi:07
# The push refers to repository [docker.io/jaguar/simpleapi]
...
# deployment "simpleapi" configured
# $
#####
